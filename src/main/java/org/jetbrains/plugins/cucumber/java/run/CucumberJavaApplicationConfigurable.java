...
public class CucumberJavaApplicationConfigurable extends SettingsEditor<CucumberJavaRunConfiguration> implements PanelWithAnchor {
  ...
  private LabeledComponentNoThrow<RawCommandLineEditor> myObjectFactory;
  ...
  public CucumberJavaApplicationConfigurable(Project project) {
    ...
    myAnchor = UIUtil.mergeComponentsWithAnchor(myMainClass, myGlue, myObjectFactory, myFeatureOrFolder, myModule, myCommonProgramParameters);
  ...
  public void setAnchor(@Nullable JComponent anchor) {
    ...
    myObjectFactory.setAnchor(anchor);
  ...
  protected void resetEditorFrom(@NotNull CucumberJavaRunConfiguration configuration) {
    ...
    myObjectFactory.getComponent().setText("cucumber.runtime.SerenityObjectFactory");
  ...
  protected void applyEditorTo(@NotNull CucumberJavaRunConfiguration configuration) {
    ...
    configuration.setObjectFactory(myObjectFactory.getComponent().getText());
